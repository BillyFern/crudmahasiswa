                ...
                <div class="card-body">
                    <form action="<?= base_url('index.php/Pinjaman/update');?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_lengkap" value="<?= $pinjaman['nama_lengkap']?>"class="form-control" id="nama lengkap" placeholder="Nama lengkap">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_telpon" value="<?= $pinjaman['no_telpon']?>" class="form-control" id="no_telpon" placeholder="No Telpon">
                        </div>
                        <div class="form-group">
                            <label for="Email">Email</label>
                            <input type="email" name="email" value="<?= $pinjaman['email']?>"class="form-control" placeholder = "Email">
                        </div>
                        <div class="form-group">
                            <label for="besar_pinjaman">Besar Pinjaman</label>
                            <input type="number" name="besar_pinjaman" value="<?= $pinjaman['besar_pinjaman']?>" class="form-control" placeholder = "Besar Pinjaman">
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="tambah" class="btn btn-primary float-right">Edit Pinjaman</button>
                    </form>
                </div>
            </div>
        </div>
